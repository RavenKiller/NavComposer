...
class Qwen25Summary:
    def __init__(
        ...
        self.qwen25_config = config.summary_config.qwen25_config
        self.model_name = self.qwen25_config.model_name
        ...
        self.temperature = self.qwen25_config.temperature
        self.system_prompt = self.qwen25_config.system_prompt
